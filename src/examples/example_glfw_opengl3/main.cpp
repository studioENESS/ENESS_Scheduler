...
void createTimeCombo(std::string sComboName, int& current_hour_idx, int& current_min_idx)
{
    ...
    // Hour
    {
        ...
        auto new_str = std::string(2 - std::min(2, int(old_str.length())), '0') + old_str;
        ...
        if (ImGui::BeginCombo("###HourTime", combo_preview_value))
        {
            for (int n = 0; n < 24; n++)
            {
                ...
                auto new_str2 = std::string(2 - std::min(2, int(old_str2.length())), '0') + old_str2;
    ...
    // Hour
    {
        ...
        if (ImGui::BeginCombo("###MinuteTime", combo_preview_value))
        {
            ...
            for (int n = 0; n < 59; n++)
            {
                ...
                auto new_str3 = std::string(2 - std::min(2, int(old_str3.length())), '0') + old_str3;
